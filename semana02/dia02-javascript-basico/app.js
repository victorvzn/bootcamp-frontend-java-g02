console.log('¡Hola Javascript desde app.js!');
...
// PRIMITIVOS: Number, String, Boolean (true, false), undefined, null
...
// var -> ES5 (Forma de declarar una variable pero ya no es recomendada) ❌
...
if (true) {
  // El bloque que se ejecutar si la condición es verdadera (true)
}
...
nombreDeLaFuncion()  // Aqupi estamos llamando a la función
...
esMayorOMenorDeEdadConRetorno(15)
